...
def get_filters():
    ...
    while True:
        ...
        if city in ['chicago', 'new york city', 'washington']:
            ...
            print("You type the city wrong. Please enter correctly!\n")
    ...
    while True:
        ...
        if month in ['january', 'february', 'march', 'april', 'may', 'june', 'all']:
            ...
            print("You type the month wrong. Please enter correctly!\n")
    ...
    while True:
        ...
        if day in ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'all']:
            ...
            print("You type the day wrong. Please enter correctly!\n")
...
def time_stats(df):
    ...
    try:
        ...
        print( "The program cannot calculate the most common month.\nAn error occurred: {}".format(e))
        # display the most common day of week
    try:
        print("The most common day of week  is ", df['day_of_week'].mode()[0], "\n")
    except Exception as e:
        print( "The program cannot calculate the most common day of week.\nAn error occurred: {}".format(e))

    # display the most common start hour
    try:
        print("The most common start hour is ", df['hour'].mode()[0])
    except Exception as e:
        print( "The program cannot calculate the most common start hour.\nAn error occurred: {}".format(e))
...
def station_stats(df):
    ...
    try:
        ...
        print("The program cannot show the most commonly used start station.\nAn error occurred: {}".format(e))
    # display most commonly used end station
    try:
        print("The most commonly used end station is ", df['End Station'].mode()[0], "\n")
    except Exceotion as e:
        print("The program cannot show the mmost commonly used end station.\nAn error occurred: {}".format(e))
    ...
    try:
        ...
        print("The program cannot show the most frequent combination of start and end station trip.\nAn error occurred: {}".format(e))
...
def trip_duration_stats(df):
    ...
    try:
        ...
        print("The program cannot calculate the total travel time.\nAn error occurred: {}".format(e))
    ...
    try:
        ...
        print("The program cannot calculate the mean travel time.\nAn error occurred: {}".format(e))
